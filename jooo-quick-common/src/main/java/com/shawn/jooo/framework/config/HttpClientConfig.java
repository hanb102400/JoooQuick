...
public class HttpClientConfig {
    ...
    public ClientHttpRequestFactory clientHttpRequestFactory() {
        ...
        if (maxTotalConnect <= 0) {
            throw new IllegalArgumentException("invalid maxTotalConnection: " + maxTotalConnect);
        }
        if (maxConnectPerRoute <= 0) {
            throw new IllegalArgumentException("invalid maxConnectionPerRoute: " + maxConnectPerRoute);
        }
